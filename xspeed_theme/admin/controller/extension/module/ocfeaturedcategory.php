...
class ControllerExtensionModuleOcfeaturedcategory extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['module_image2']) && is_file(DIR_IMAGE . $this->request->post['module_image2'])) {
            $data['thumb2'] = $this->model_tool_image->resize($this->request->post['module_image2'], 100, 100);
        } elseif (!empty($module_info) && is_file(DIR_IMAGE . $module_info['module_image2'])) {
            $data['thumb2'] = $this->model_tool_image->resize($module_info['module_image2'], 100, 100);
        } else {
            $data['thumb2'] = $this->model_tool_image->resize('no_image.png', 100, 100);
        }
		// var_dump($data['thumb2']);die;
