...
function customResponsive(){
	...
	if(window_w>1024){
		var top_h = $('.top-header').outerHeight();
		var bg_pos = 'center ' + $('.top-header').outerHeight() + 'px';
		// console.log(bg_pos);
		$('body.common-home.home4 .middle-header').css('margin-top',top_h+10);
		$('body.common-home.home4').css('background-position', bg_pos);
	} else {
		$('body.common-home.home4 .middle-header').removeAttr( "style" );
		$('body.common-home.home4').removeAttr( "style" );
	}
	...
	var top_h2 = '30%';
	if(window_w>=768){
		$('.fixed-right').css('top',top_h2);
	} else {
		$('.fixed-right').css('top',top_h);
	}
...
$(document).ready(function() {
	...
	$('.group2 .middle-header').after('<div class="headerSpace unvisible" style="height:'+headerSpaceH+'px;"></div>');	
	// Scroll
	var currentP = 0;
	var stickyOffset = 0;
			...
			if($(window).width() > 1024){
				if(scrollP != currentP){
					...
					if(scrollP >= stickyOffset){
						...
						$('.group2 .middle-header').addClass('fix-header');
						$('.headerSpace').removeClass('unvisible');
					} else {
						$('.group1 .container-fix').removeClass('fix-header');
						$('.group2 .middle-header').removeClass('fix-header');
