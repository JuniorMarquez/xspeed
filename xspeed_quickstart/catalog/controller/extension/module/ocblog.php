	...
	public function index($setting) {
		...
		foreach ($results as $result) {
			$data['articles'][] = array(
				...
				'date_added2'  => date($this->language->get('date_format_short'), strtotime($result['date_added'])),
				'date_added'  => date('d/m/Y', strtotime($result['date_added'])),
				'date_added_m'  => date("F", strtotime($result['date_added'])),
				'date_added_d'  => date("j", strtotime($result['date_added'])),
				'intro_text' => substr(html_entity_decode($result['intro_text'], ENT_QUOTES, 'UTF-8'),0,200).'...',
